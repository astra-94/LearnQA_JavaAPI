...
public class DataGenerator {
    ...
    {
        String name = RandomStringUtils.randomAlphanumeric(number).toLowerCase();
        return name;
    }

    public static Map<String, String> getRegistrationDataWithRandomName(int number)
    {
        Map<String,String> data = new HashMap<>();
        data.put("email", DataGenerator.getRandomEmail());
        data.put("password", "123");
        data.put("username", "learnqa");
        data.put("firstName", DataGenerator.getRandomName(number));
        data.put("lastName", "learnqa");
